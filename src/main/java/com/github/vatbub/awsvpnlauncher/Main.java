...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (String arg : args) {
            if (arg.toLowerCase().matches("privatekey=.*")) {
                // Set the mock version
                privateKey = new File(arg.substring(arg.toLowerCase().indexOf('=') + 1));
            }
        }
        ...
        try {
            ...
            for (Instance instance : instances) {
                ...
                String sshIp = "ec2-" + newInstance.getPublicIpAddress().replace(".", "-") + ".eu-central-1.compute.amazonaws.com";
    ...
    private static void printHelpMessage() {
        ...
        System.out.println("-h, --help, /?, /help:\t\tDisplay this help message");
    }
